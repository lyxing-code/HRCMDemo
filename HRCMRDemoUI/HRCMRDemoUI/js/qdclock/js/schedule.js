		...
		var render = function() {
			...
			for(var i = 0; i < total; i++) {
				if(i < startWeek) {
					...
					var Morning = '';
					var Afternoon = '';
					//正常					selectedDate == nowDate && (addClass = 'selected-style');
                    ...
                    for (var z = 0; z < zt.length; z++) {
                        zt[z].time == nowDate && (addClass = 'zt-style', Morning = zt[z].Morning, Afternoon = zt[z].Afternoon);
                    }
                    //早退迟到
                    for (var z = 0; z < cdzt.length; z++) {
                        cdzt[z].time == nowDate && (addClass = 'cdzt-style', Morning = cdzt[z].Morning, Afternoon = cdzt[z].Afternoon);
                    }
